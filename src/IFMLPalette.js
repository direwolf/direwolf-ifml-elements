...
export default class IFMLPalette extends LitElement {
  ...
  render() {
    return html`
      ...
      <div id="palette-view-container" class="item">
      ...
      <div id="palette-action" class="item">
      ...
      <div id="palette-view-component" class="item">
      ...
      <div id="palette-view-component-form" class="item">
        <svg xmlns="http://www.w3.org/2000/svg" width="150" height="80">
          <g class="model-element model-node">
            <rect width="150" height="80" fill="lightgray" stroke="black" stroke-width="1" rx="15" ry="15"></rect>
      ...
      <div id="palette-view-component-list" class="item">
        <svg xmlns="http://www.w3.org/2000/svg" width="150" height="80">
          <g class="model-element model-node">
            <rect width="150" height="80" fill="lightgray" stroke="black" stroke-width="1" rx="15" ry="15"></rect>
  ...
  firstUpdated(changedProperties) {
    Gestures.addListener(this.shadowRoot.getElementById('palette-event'), 'track', this._handleTrack.bind(this));
    Gestures.addListener(this.shadowRoot.getElementById('palette-action'), 'track', this._handleTrack.bind(this));
    Gestures.addListener(this.shadowRoot.getElementById('palette-view-container'), 'track', this._handleTrack.bind(this));
    Gestures.addListener(this.shadowRoot.getElementById('palette-view-component'), 'track', this._handleTrack.bind(this));
    Gestures.addListener(this.shadowRoot.getElementById('palette-view-component-form'), 'track', this._handleTrack.bind(this));
    Gestures.addListener(this.shadowRoot.getElementById('palette-view-component-list'), 'track', this._handleTrack.bind(this));
  }
